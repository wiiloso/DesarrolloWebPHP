<?php
	...
	$dataestudiante = $estudiantes->obtenerEstudiantebyId(1);
	...
	$pdf->Cell(150,10,iconv("UTF-8", "ISO-8859-1",strtoupper("Reporte General Estudiantes")),0,0,'L');
	...
	$pdf->SetFont('Arial','',10);
	$pdf->SetTextColor(39,39,51);
	$pdf->Cell(13,7,iconv("UTF-8", "ISO-8859-1","Fecha Nacimiento: ". $fecha_nacimiento),0,0);
	...
	$pdf->SetFont('Arial','',10);
	$pdf->SetTextColor(39,39,51);
	$pdf->Cell(13,7,iconv("UTF-8", "ISO-8859-1","Grado: ". $grado),0,0);
	...
	$pdf->SetTextColor(39,39,51);
	$pdf->MultiCell(0,9,iconv("UTF-8", "ISO-8859-1","*** Codigo Estudiantil ***"),0,'C',false);
	...
	$pdf->Output("I","Ficha Estudiantil_Nro_0000123454.pdf",true);