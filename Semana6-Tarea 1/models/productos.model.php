...
";
    ...
    public function actualizar($idProductos,$Codigo_Barras, $Nombre_Producto, $Graba_IVA, $Unidad_Medida_idUnidad_Medida, $IVA_idIVA, $Cantidad, $Valor_Compra, $Valor_Venta, $Proveedores_idProveedores) // update productos set ... where id = $idProductos
    {       
        try {
            $con = new ClaseConectar();
            $con = $con->ProcedimientoParaConectar();
            ...
            if (mysqli_query($con, $cadena)) {
                ...
                $cadenaKardex = "UPDATE `Kardex` SET 
                                ...
                                `Unidad_Medida_idUnidad_Medida1`='$Unidad_Medida_idUnidad_Medida',
                                `Unidad_Medida_idUnidad_Medida2`='$Unidad_Medida_idUnidad_Medida',
                                `IVA`='$IVA_idIVA',
                                `IVA_idIVA`='$IVA_idIVA',
                                `Proveedores_idProveedores`='$Proveedores_idProveedores',
                                `Productos_idProductos`='$idProductos',
                                `Tipo_Transaccion`=1
